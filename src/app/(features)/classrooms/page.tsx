        ...
        <Card className="max-w-5xl mx-auto section-card">
          ...
          <CardContent className="space-y-3">
            {classrooms.length > 0 ? classrooms.map(classroom => {
              ...
              return (
                <div key={classroom.id} className="flex items-center justify-between p-4 rounded-lg border bg-card/90 shadow-sm hover:shadow-md transition-all duration-200">
                  <div className="space-y-1">
                    <h3 className="font-semibold text-lg">{t("Grade")} {classroom.grade} - {t("Section")} {classroom.section}</h3>
